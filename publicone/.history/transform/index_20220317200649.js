...
// import { elementData, cyclicData } from './transform_common.js'
import { getData, elementData, cyclicData } from './transform_common.js'
...
// var it = find(node, (n) => {
//     return n.tagName == 'div' && n.properties.className[0] == 'content-one';
// });
// console.log(it);
// var flag = true;
// while (flag) {
